		...
		<div class="feature-section col one-col">
			...
			<h4>درخواست همکاری</h4>
				<p>
					...
					همچنین اگر شما برنامه‌نویس یا توسعه‌دهنده هستید، می‌توانید به صورت مستقیم و با استفاده از ‪<a href="https://github.com/wp-persian/wp-jalali">مخزن گیت‌هاب افزونه</a>‬، مشکلات و راه‌حل‌های فنی خود را پیشنهاد کنید و در توسعه افزونه مشارکت داشته باشید. 
				</p>
			</div>
		</div>
