<div class="wrap about-wrap">
    ...
    <div class="about-text">از شما بابت استفاده از بروزترین نسخه افزونه وردپرس فارسی (wp-jalali) سپاسگزاریم.</div>
    ...
    <div class="changelog">
        ...
        <div class="feature-section col three-col">
            <div class="col-1">
                ...
                <h4>بهینگی</h4>
                <p>با استفاده از الگورتیم‌های بروزشده سرعت افزونه بالاتر و مصرف منابع تا 200% کاهش داده شده است.</p>
            </div>
            <div class="col-2"> 
                <h4>کیفیت افزونه</h4>
            ...
            <div class="col-3 last-feature"> 
                <h4>امنیت</h4>
                <p>ما به مهمترین دغدغه کاربران برای داشتن یک افزونه امن پاسخ مثبت داده ایم، خیالتان راحت باشد.</p>
            </div>
        </div>
